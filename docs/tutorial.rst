...
.. _`Edit this file`: https://github.com/thomasjahoda/cookiecutter-pypackage/blob/master/docs/tutorial.rst
...
.. code-block:: bash
    ...
    cookiecutter https://github.com/thomasjahoda/cookiecutter-pypackage.git
...
You should still be in the folder containing the ``setup.py`` file.
...
.. _`Issues`: https://github.com/thomasjahoda/cookiecutter-pypackage/issues

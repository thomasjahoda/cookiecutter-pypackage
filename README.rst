...
.. image:: https://travis-ci.org/thomasjahoda/cookiecutter-pypackage.svg?branch=master
    :target: https://travis-ci.org/github/thomasjahoda/cookiecutter-pypackage
    :alt: Build Status
...
* GitHub repo: https://github.com/thomasjahoda/cookiecutter-pypackage/
...
* Install the dev requirements into a virtualenv via ``make install-dev``
